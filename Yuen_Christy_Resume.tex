...
%----------------------------------------------------------------------------
% Projects
\section{\seticon{faTerminal} \textbf{PROJECTS \& EXPERIENCE}}
    \resumeSubHeadingListStart
      \resumeProjectHeading 
      %----------------------------------------------------------------------------
      % RA
          {\href{https://www.linkedin.com/in/yuenchristy/}{\myuline{\textbf{Resident Assistant (RA)}}} $|$ \textit{HTML, CSS}}{August 2021 - June 2022}
          \resumeItemListStart
