...
\section{\seticon{faTerminal} \textbf{EXPERIENCE \& PROJECTS}}
    \resumeSubHeadingListStart
      ...
      %----------------------------------------------------------------------------
      % California Seismic 
      {\href{https://californiaseismic.com/}{\myuline{\textbf{Front End Intern}}} $|$ \textit{AWS, Git, React, Jest, HTML, Tailwind}}{June 2023 - Present}
      {California Seismic}{Remote}
      \resumeItemListStart
            \resumeItem{Utilize Scrum methodology to foster effective collaboration and drive iterative development}
            \resumeItem{Used React.js and D3 to create a base shear diagram for accurate and interactive visualization}
            \resumeItem{Collaborated with designers to translate wireframes into fully functional web interfaces}
          \resumeItemListEnd
      \resumeSubheading
      %----------------------------------------------------------------------------
